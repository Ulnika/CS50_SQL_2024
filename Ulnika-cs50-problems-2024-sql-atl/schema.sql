...
CREATE TABLE "check_ins"(
    ...
    PRIMARY KEY("id"),
    FOREIGN KEY("flight") REFERENCES "flights"("flight number"),
    FOREIGN KEY("passenger_id") REFERENCES "passengers"("id"),
    FOREIGN KEY("airlines") REFERENCES "airlines"("id")
);
...
CREATE TABLE "flights"(
    ...
    "expected_departure_time" NUMERIC NOT NULL DEFAULT TIMESTAMP,
    "expected_arrival_time" NUMERIC NOT NULL DEFAULT TIMESTAMP,
