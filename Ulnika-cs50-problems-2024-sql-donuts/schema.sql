...
Ingredients
We certainly need to keep track of our ingredients. Some of the typical ingredients we use include flour, yeast, oil, butter,
...
CREATE TABLE "donuts"(
    ...
    "ingredients" TEXT,
    PRIMARY KEY("id"),
    FOREIGN KEY("ingredients") REFERENCES"ingredients"("ingredient")
);
