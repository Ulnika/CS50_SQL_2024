...
Using your by_district view, you should find that the Mustang district has only 3,751 families.*/
...
--SELECT * FROM "by_district" ORDER BY "families" ASC LIMIT 1 OFFSET 1
